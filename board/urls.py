from board.views import board, board_search, board_show_life, board_show_recipe, boardpost, post_detail, comments_create, comments_delete, post_delete, post_edit, reply_create, reply_delete
from django.urls import path

urlpatterns = [
    path('', board, name='board'),
    path('new/', boardpost, name='boardpost'),
    path('post/<int:board_id>/', post_detail, name='boardpost_detail'),
    path('post/<int:pk>/', post_detail, name='boardpost_detail'),
    ...
    path('post/<int:board_id>/edit/', post_edit, name='post_edit'),
]
